...
public final class C1992lT {
    ...
    public C1992lT(char c, float[] fArr) {
        this.f6172z = c;
        this.f6171h = fArr;
    }

    /* renamed from: h */
    public static void m3603h(C1992lT[] c1992lTArr, Path path) {
        int i;
        int i2;
        char c;
        C1992lT c1992lT;
        ...
        float f20;
        float f21;
        C1992lT[] c1992lTArr2 = c1992lTArr;
        int i4 = 6;
        ...
        char c3 = 'm';
        int i6 = 0;
        while (i6 < c1992lTArr2.length) {
            C1992lT c1992lT2 = c1992lTArr2[i6];
            char c4 = c1992lT2.f6172z;
            float f22 = fArr[i5];
            float f23 = fArr[1];
            float f24 = fArr[2];
            float f25 = fArr[3];
            ...
            while (true) {
                ...
                if (i7 < fArr2.length) {
                    if (c4 != 'A') {
                                ...
                                if (c4 != 'Q') {
                                    if (c4 != 'V') {
                                        if (c4 != 'a') {
                                            ...
                                            c1992lT = c1992lT2;
                                            i3 = i6;
                                            m3604z(path, f51, f50, f52, f53, f54, f55, f56, z3, z4);
                                            f30 = f51 + fArr2[i34];
                                            f31 = f50 + fArr2[i35];
                                        }
                                    } else {
                        ...
                        m3604z(path, f60, f59, f61, f62, f63, f64, f65, z, z2);
                        f30 = fArr2[i46];
                        f31 = fArr2[i47];
                    }
                    f25 = f31;
            ...
            c2 = 'm';
            i5 = i49;
            c3 = c1992lTArr[i48].f6172z;
            c1992lTArr2 = c1992lTArr;
        }
    }

    /* renamed from: z */
    public static void m3604z(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        double d;
        double d2;
        ...
        if (d20 < 0.0d) {
            ...
            m3604z(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
            return;
        }
    ...
    public C1992lT(C1992lT c1992lT) {
        this.f6172z = c1992lT.f6172z;
        float[] fArr = c1992lT.f6171h;
        this.f6171h = AbstractC1843ih.m3412I(fArr, fArr.length);
    }
}
