...
public abstract class AbstractC0106C4 {

    /* renamed from: z */
    public static final ThreadLocal f396z = new ThreadLocal();

    /* renamed from: h */
    public static int m228h(int i, int i2) {
        int i3;
        int i4;
    ...
    /* renamed from: v */
    public static int m229v(int i, int i2) {
        if (i2 < 0 || i2 > 255) {
    ...
    /* renamed from: z */
    public static int m230z(double d, double d2, double d3) {
        double d4;
        double d5;
        double d6;
        int min;
